...
sasl_plain_username=data['JPBHHHQIBS5ERSAD'];
sasl_plain_password=data['f29z+Xg3EFGXodAqDYfpcTkbpIxKmCl8rZv1/Lxh1FId32+nPs97wcCRrBbFBCnA'];
topicName='ToMySQL'                        #TODO: fill by topic name
